  ...
  request("https://www.reddit.com/r/news/", function(error, response, html) {
    ...
    $("p.title").each(function(i, element) {
      ...
      entry.save(function(err, doc) {
        ...
        modalResult = {show: "show" ,found: scrapeCount};

console.log(modalResult);
        res.render("index",modalResult);
...
app.get("/articles", function(req, res) {
  ...
  Article.find({}).exec(function(error, doc) {
    ...
    // Or send the doc to the browser as a json object
      ...
      res.render("found",{doc,recordsFound});
    }
  });
});
...
app.get("/api", function(req, res) {
  // Grab every doc in the Articles array
Article.find({}).populate("notes").exec(function(error, doc) {
    // Log any errors
    if (error) {
      console.log(error);
    }
...
// This will get the articles we scraped from the mongoDB
app.get("/apiNote", function(req, res) {
  // Grab every doc in the Articles array
